...
;                    moveDown(gridX * 100,(gridY * 100)-100);
                ...
                if (leftAndRight == 2){
                    if (direction == TimeDirection.Right) {
                        moveRight((gridX * 100) - 100,(gridY * 100));
                        gridX++;
                    }
                    if (direction == TimeDirection.Left) {
                        moveLeft((gridX * 100) - 100,(gridY * 100));
                        gridX--;
                    }
                }
            ...
            case Move.right:
                ...
                if (direction == TimeDirection.Up) {
                    direction = TimeDirection.Right;
                } else if ( direction == TimeDirection.Down ){
                    direction = TimeDirection.Left;
                } else if ( direction == TimeDirection.Right ){
                    direction = TimeDirection.Down;
                } else if ( direction == TimeDirection.Left ){
                    direction = TimeDirection.Up;
                }
                break;
            //サブルーチン実行
            case Move.function:
